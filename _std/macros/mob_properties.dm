...
#define PROP_TEMP_CHEM_DEPLETION(x) x("chem_deplete_heat", APPLY_MOB_PROPERTY_SIMPLE, REMOVE_MOB_PROPERTY_SIMPLE)
#define PROP_TEMP_CHEM_EFFECTS(x) x("chem_effect_heat", APPLY_MOB_PROPERTY_SIMPLE, REMOVE_MOB_PROPERTY_SIMPLE)
#define PROP_TEMP_DIGESTION(x) x("digestion_heat", APPLY_MOB_PROPERTY_SIMPLE, REMOVE_MOB_PROPERTY_SIMPLE)
#define PROP_TEMP_CRIT(x) x("crit_heat", APPLY_MOB_PROPERTY_SIMPLE, REMOVE_MOB_PROPERTY_SIMPLE)
