...
/obj/item/reagent_containers/glass
	...
	attackby(obj/item/I as obj, mob/user as mob)
		...
		else if (istype(I, /obj/item/ammo/magazine/bullet_22) || istype(I, /obj/item/ammo/magazine/a38) || istype(I, /obj/item/ammo/magazine/custom) || (I.type == /obj/item/handcuffs) || istype(I,/datum/projectile/bullet/revolver_38))
